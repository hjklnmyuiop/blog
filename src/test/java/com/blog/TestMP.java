...
public class TestMP {
    ...
    private static String author ="dev_guo";//作者名称
    ...
    private static String url="jdbc:mysql://192.168.5.232:3306/ptx_ad_system_dev?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC" ;
    @Value("${spring.datasource.ds1.username}")
    private static String username="cc" ;//数据库用户名
    @Value("${spring.datasource.ds1.password}")
    private static String password ="patozon&123";//数据库密码
    private static String tablePrefix ="adv_";//数据库表的前缀，如tbl_user
    private static String [] tables = {"request_api_log","adv_custom_columns"};	//生成的表
    private static String parentPackage = "com.ptx.ad";//顶级包结构
