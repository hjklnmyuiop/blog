...
public class BlogtypeAdminController {
    ...
    public String typeManage(){
        return "admin/type/typeManage";
    }


    @ResponseBody
    @RequestMapping("/list")
    public String list(Blogtype blogtype,Integer page,Integer rows){
        Map<String,Object> map= new HashMap<>();
        //创建分页对下，指定每页
        Page<Blogtype> pageInfo = new Page<Blogtype>(page,rows);
        IPage<Blogtype> blogIPage =  blogtypeService.findBlogTypeByPage(pageInfo,blogtype);

//        Page<Blogtype> pageInfo = new Page<>(page, rows);
//        IPage<Blogtype> blogIPage = blogtypeService.findBlogTypeByPage(pageInfo, blogtype);
